...
namespace api.Apis.V1.Controllers
{
    ...
    public class WeatherForecastController : ControllerBase
    {
        ...
        [HttpPost("post-with-error")]
        public IActionResult PostWithError([FromBody] DummyModel model)
        {
            throw new InvalidOperationException("The POST exception was intentionally thrown");
        }
        [HttpGet("throw-error")]
